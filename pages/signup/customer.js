    ...
    <>
      <Layout title="Customer Sign Up">
        ...
        {Object.keys(data).length ? (
          ...
          >
            <div className="col-span-2 place-self-center text-3xl font-bold text-dark ">
              Sign up
            </div>
            ...
            <button
              type="submit"
              className="col-span-2 w-48 place-self-center rounded-full bg-cream px-10 py-1 text-lg font-bold leading-tight hover:opacity-75 disabled:brightness-75"
            >
              create your account
            </button>
